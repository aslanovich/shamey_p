...
const PLANS = [
  {
    ...
    items: ["50 минут", "Онлайн", "Оплата перед сессией"],
    cta: "Записаться",
    featured: false,
    badge: null,
  },
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 md:gap-6">
          {PLANS.map((plan, i) => (
            <div
              key={plan.title}
              className={`reveal relative flex flex-col rounded-[32px] p-8 ${
        ...
        <div
          className="reveal mt-6 grid items-center gap-6 rounded-[32px] bg-lavender-card p-8 md:mt-10 md:grid-cols-[auto_1fr] md:gap-10 md:p-10"
        ...
        >
          <div className="flex items-center justify-center gap-4 md:flex-col md:gap-3">
            ...
            <p className="text-4xl leading-none md:text-5xl">24 часа</p>
          </div>
          <div>
